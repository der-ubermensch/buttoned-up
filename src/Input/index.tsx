...
const StyledInput = styled.input<InputProps>`
    ...
    width: 300px;
    border-radius: 3px;
    border: solid 2px ${(props: InputProps) => props.disabled ? "#e4e3ea" :(props.error ? "#a9150b":(props.success ? "#067d68" : "#353637"))};
...
const StyledLabel = styled.div<InputProps>`
   font-size: 14px;
   color: ${(props: InputProps) => props.disabled ? "#e4e3ea" : "#080808"};
   padding-bottom: 6px;
`;
...
const StyledText = styled.p<InputProps>`
   margin: 0px;
   color: ${(props: InputProps) => props.disabled ? "#e4e3ea" : (props.error ? "#a9150b": "#080808")};
`;
