...
const StyledButton = styled.button<ButtonProps>`
    ...
    padding: ${(props: ButtonProps) => props.size === "small"? "7px 25px 8px" : (props.size === "medium"? "9px 30px 11px" : "14px 30px 16px" )};
    ...
    &:hover {
      background-color: ${(props: ButtonProps) => props.primary ? "#55bd90":"#6bedb5"};
    }
    &:active {
        border: solid 2px #1b116e;
        padding: ${(props: ButtonProps) => props.size === "small"? "5px 23px 6px" : (props.size === "medium"? "7px 28px 9px" : "12px 28px 14px" )};
    }
`;
